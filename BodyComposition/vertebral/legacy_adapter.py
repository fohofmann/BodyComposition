"""Common-contract adapter for the retained internal vertebral-body models."""
...
def adapt_internal_vertebral_bodies(
    ...
    *,
    ...
    if model_preset not in LEGACY_BACKEND_IDS:
    ...
    return VertebralResult(
        backend_id=LEGACY_BACKEND_IDS[model_preset],
